...
// + Cloud Messaging API (Legacy), apiKey: Web configuration/Web Push certificates/Key pair
    ...
    if (firebase && firebase.messaging()) {
        ...
        firebase.messaging().requestPermission().then(() => {
            ...
            firebase.messaging().getToken().then((fcmToken) => {
                document.getElementById("fcmToken").innerText = "Token retreived.";
                logger("+ Firebase FCM token for this device's web application:  " + fcmToken);
            }).catch((err) => {
...
function clearTextAreas() {
    log.value = "+ Ready";
    document.getElementById("fcmToken").innerText = "";
}
